...
public class AppNumeri {
    public static void main(String[]args){
        ...
        int opzione, QuantiNumeri=0, posizione=0, Posizione=0;
        boolean fine=true;
        int[]vetNumeri=null;
        int[]vetPari=null;
        int[]vetDispari=null;
    ...
    switch(opzione){
        ...
        break;
        case 3:       System.out.println("calcola numeri pari, clicca 4 per vederli!");
        ...
        case 4:
            ...
            break;
        case 5:       System.out.println("calcolo numeri dispari, clicca 6 per vederli");
    ...
    private static void menu(){
        ...
        System.out.println("[3] genera pari");
        System.out.println("[4] visualizza pari");
        System.out.println("[5] genera dispari");
        System.out.println("[6] visualizza dispari");
